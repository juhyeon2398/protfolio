...
mainTL01
  .from("#mainVisual .mainVisual01 h2 .sub .char", {
    duration: 0.5,
    y: 50,
    opacity: 0,
    stagger: {
  ...
  .from(
    "#mainVisual .mainVisual01 h2 .main .char",
    {
      duration: 0.5,
      y: 50,
      opacity: 0,
...
mainTL02
  .from("#mainVisual .mainVisual02 h2 .sub .char", {
    duration: 0.5,
    y: 50,
    opacity: 0,
    stagger: {
  ...
  .from(
    "#mainVisual .mainVisual02 h2 .main .char",
    {
      duration: 0.5,
      y: 50,
      opacity: 0,
...
mainTL03
  .from("#mainVisual .mainVisual03 h2 .sub .char", {
    duration: 0.5,
    y: 50,
    opacity: 0,
    stagger: {
  ...
  .from(
    "#mainVisual .mainVisual03 h2 .main .char",
    {
      duration: 0.5,
      y: 50,
      opacity: 0,
...
new fullpage("#main", {
  ...
  onLeave: function (section, destination, direction) {
    ...
    if (idx == 0) {
      ...
      $(".address").css("color", "rgba(255, 255, 255, 0.6)");
      $(".address strong").css("color", "#fff");
      $(".address .btnBox").css("color", "#fff");
      $(".address .btnBox").css("border-color", "#fff");
      $(".address .btnBox button").css("color", "#fff");
      $("#header #logo a.white").css("opacity","1");
      $("#header #logo a.black").css("opacity","0");
    } else if (idx == 1) {
      img.restart();
      header.css("color", "#333");
      $(".address").css("color", "#000");
      $(".address .btnBox").css("color", "#000");
      $(".address .btnBox").css("border-color", "#000");
      $(".address .btnBox button").css("color", "#000");
      $(".address strong").css("color","#000")
      $(".address").css("opacity", "1");
      $("#header #logo a.white").css("opacity","0");
      $("#header #logo a.black").css("opacity","1");
